...
export function Pricing({ d }: { d: Dictionary }) {
  const plans = [
    ...
    { ...d.pricing.plans.creator, price:'$19',period:'/month',href:PAY?SL.creatorMonthly:'#tool',highlighted:true },
    { ...d.pricing.plans.pro, price:'$39',period:'/month',href:PAY?SL.proMonthly:'#tool',highlighted:false },
  ]
